...
func (x *calculatorServiceAverageClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceAverageClient) CloseAndRecv() (*Response, error) {
...
func (x *calculatorServiceAverageServer) SendAndClose(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceAverageServer) Recv() (*Request, error) {
	m := new(Request)
